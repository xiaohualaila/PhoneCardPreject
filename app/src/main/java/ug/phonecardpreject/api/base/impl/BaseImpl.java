...
package ug.phonecardpreject.api.base.impl;
...
import ug.phonecardpreject.util.CacheUtil;
...
//                .client(client)                                     // 设置 client
    ...
    private boolean alreadyHasAuthorizationHeader(Request originalRequest) {
        ...
        return !(null == token || token.isEmpty() || originalRequest.url().toString().contains(Constant.BASE_URL));
    }
